...
int main()
{
	...
	int a = 3, b = 5, enteries = 4 /*входы ИНС*/, n = 30/*количество значений для обучения*/, values = 15/*количество значений для прогнозирования*/;
	double d = 0.5, Em = 0.05/*минимальная среднеквадратичная ошибка сети*/, E/*суммарная среднеквадратичная ошибка сети*/, T = 1 /*порог НС*/;
